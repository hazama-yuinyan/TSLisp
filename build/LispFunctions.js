...
(function (TSLisp) {
    ...
    TSLisp.built_in_funcs = [
        ...
        {
            dump: function () {
                var keys = TSLisp.LL.listFrom(new Common.List(TSLisp.interp.SymbolTable.Keys));
            ...
            help: function (arg) {
                if(arg == null) {
                    ...
                    if(func_obj.help_msg) {
                        ...
                        if(func_obj.body) {
                            throw ErrorFactory.makeEvalException('The symbol "{arg}" doesn\'t refer to a function!', {
                                arg: arg.toString()
                            });
                        } else {
                            throw ErrorFactory.makeEvalException('The target function "{arg}" doesn\'t seem to have help message.', {
                                arg: arg.toString()
                            });
                        }
                    }
        ...
        }, 
        {
            ...
            is_lazy: false,
            accepts_variable_args: true,
            help_msg: "(max (a ...)) => the largest number among all the numbers in the list supplied to the function or nil" + "(if any one of the elements in the list is not a number or when an empty list is supplied)"
        }, 
        {
            ...
            is_lazy: false,
            accepts_variable_args: true,
            help_msg: "(min (a ...)) => the smallest number among all the numbers in the list supplied to the function or nil" + "(if any one of the elements in the list is not a number or when an empty list is supplied)"
        }, 
        {
